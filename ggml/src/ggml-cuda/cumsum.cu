...
static void cumsum_cub(ggml_cuda_pool & pool,
    ...
    (void) cub::DeviceScan::InclusiveSum(nullptr,   // d_temp_storage (null = just query size)
    ...
    (void) cub::DeviceScan::InclusiveSum((void *) tmp_alloc.get(), tmp_size, src, dst, ne, stream);
}
#endif // GGML_CUDA_USE_CUB
