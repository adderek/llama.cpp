...
llama_mmap::llama_mmap(struct llama_file * file, size_t prefetch, bool numa, bool hugetlb,
        const ranges & lazy_ranges) : pimpl(std::make_unique<impl>(file, prefetch, numa, hugetlb, lazy_ranges)) {}
